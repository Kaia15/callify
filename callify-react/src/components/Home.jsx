...
export default function Home() {
    ...
    const handleJoinMeeting = async () => {
        try {
            ...
            // setShowMeeting(true);  // Show the meeting container
    ...
    return (
        <div>
                ...
                <div className="flex-1 p-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <button className="bg-red-500 text-white p-6 rounded-lg shadow-lg flex items-center justify-center"
                            onClick={() => { /* Implement your new meeting logic here */ }}>
                            <span className="text-xl font-semibold">New Meeting</span>
                        </button>
                        <button className="bg-blue-500 text-white p-6 rounded-lg shadow-lg flex items-center justify-center"
            ...
            {/* Hidden Zoom Meeting Container */}
            {/* {showMeeting && (
                <div id="zmmtg-root" style={{ display: 'block' }}></div>
            )} */}
        </div>
    );
}
